...
2. **分析關係結構**
   - 優先關注 gender 為 male、femboy 的人物
   - 找出可能的 BL 配對組合
   - **注意關係來源（source 欄位）**：利用「情侶關係」、「互相餵飯」、「手牽手」等來源豐富劇情
   - 識別攻受屬性（根據性格描述或關係來源推測）
   - 找出三角關係、暗戀、修羅場可能性
...
3. **生成甲甲劇情**（必須符合以下所有規範）
   ...
   **劇情結構要求**：
   ...
   - 第一段：設定關係與曖昧氛圍（強調眼神交流、小動作）
   - 中間段：情感升溫、衝突爆發、三角關係介入
   - 最後段：告白或修羅場高潮

4. **語氣與氛圍**
   - 主劇情用耽美小說風格，強調情感張力與曖昧氛圍
   - 適度加入年輕人用語（「這根本在發糖」、「太會了吧」、「磕到了」）
   - 強調肢體語言細節（牽手、對視、擁抱、壁咚等）
